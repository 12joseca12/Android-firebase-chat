...
import com.example.josechat.adapter.RecentChatRecyclerAdapter;
...
public class ChatFragment extends Fragment {
    ...
    void setUpRecyclerView(){
        ...
        Query query= FirebaseUtil.allChatroomCollectionReference().whereArrayContains("userIds", FirebaseUtil.currentUserID()).orderBy("lastMessageTimestamp", Query.Direction.DESCENDING);
